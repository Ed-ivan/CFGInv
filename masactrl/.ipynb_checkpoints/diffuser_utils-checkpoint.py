...
#TODO： 这里添加了一点的内容啊 
def linear_schedule(t, guidance_scale, tau1=0.1, tau2=0.8):
    t = t / 50
            ...
            if do_separate_cfg:
                ...
                if (i >= prox_step) and (prox == 'l0' or prox == 'l1'):
                    ...
                    if prox == 'l1':
                        ...
                        score_delta = torch.where(score_delta < 0, score_delta+threshold, score_delta)
                #TODO:在这里面添加了 linear scale的技术 , 啊 没事 跟我想得有点不一样的，别慌 , 这里面还得在研究下 
                guidance_scale_1=linear_schedule(t,guidance_scale_1,tau1=0.2, tau2=0.8)
